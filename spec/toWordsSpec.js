...
describe('toWords', function () {
  const tests = [
    ...
    { input: 1000000000000, expect: 'one trillion' },
    {
      input: 2222222222222,
      expect:
        'two trillion, two hundred twenty-two billion, two hundred twenty-two million, two hundred twenty-two thousand, two hundred twenty-two',
    },
    { input: 10000000000000, expect: 'ten trillion' },
    {
      input: 33333333333333,
      expect:
        'thirty-three trillion, three hundred thirty-three billion, three hundred thirty-three million, three hundred thirty-three thousand, three hundred thirty-three',
    },
    { input: 100000000000000, expect: 'one hundred trillion' },
    {
      input: 444444444444444,
      expect:
        'four hundred forty-four trillion, four hundred forty-four billion, four hundred forty-four million, four hundred forty-four thousand, four hundred forty-four',
    },
